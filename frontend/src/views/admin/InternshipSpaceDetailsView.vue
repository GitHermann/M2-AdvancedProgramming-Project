    ...
    <form class="login-form" @submit.prevent="saveEdit" :class="{ loading: loading }">
      ...
      <div class="input-form-container">
        ...
        <input
          type="number"
          id="promotion"
          v-model="internshipSpace.promotion"
          class="input-form"
          required
          :disabled="disabled"
        />
      ...
      <div class="textarea-form-container">
        ...
        <textarea
          id="tutors_instruction"
          v-model="internshipSpace.tutors_instruction"
          class="textarea-form"
          required
          :disabled="disabled"
        ></textarea>
      ...
      <div class="textarea-form-container">
        ...
        <textarea
          id="students_instruction"
          v-model="internshipSpace.students_instruction"
          class="textarea-form"
          required
          :disabled="disabled"
        ></textarea>
      ...
      <div class="input-form-container">
        ...
        <input
          type="date"
          id="startSubmissionDate"
          v-model="internshipSpace.startSubmissionDate"
          class="input-form"
          required
          :disabled="disabled"
        />
      ...
      <div class="input-form-container">
        ...
        <input
          type="date"
          id="endSubmissionDate"
          v-model="internshipSpace.endSubmissionDate"
          class="input-form"
          required
          :disabled="disabled"
        />
      ...
      <div class="action-buttons-container">
        <button class="action-button" id="edit" @click="showAllInternships">
          Afficher tous les stage
        </button>
        <button class="action-button" id="edit" @click="editSpace" v-if="!editing">Modifier</button>
        <button class="action-button" id="edit" @click="saveEdit" v-if="editing">
          Sauvegarder
        </button>
...
<script>
import {
  getOneInternshipSpace,
  editInternshipSpace,
  deleteInternshipSpace
} from '@/api/internshipSpaces'
...
export default {
  ...
  methods: {
    ...
    showAllInternships() {
      this.$router.push(`/admin/internship-spaces/${this.internshipSpaceId}/internships`)
    }
  }
}
</script>
